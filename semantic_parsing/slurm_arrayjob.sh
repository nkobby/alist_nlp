...
proj_home=/home/${USER}/alist_nlp/semantic_parsing  # you may need to change this
src_path=${proj_home}/semantic_parsing/data/input

# input data directory path on the scratch disk of the node
dest_path=${SCRATCH_HOME}/alist_nlp/semantic_parsing/data/input
...
src_path=${SCRATCH_HOME}/alist_nlp/semantic_parsing/data/output
dest_path=${proj_home}/semantic_parsing/data/output
rsync --archive --update --compress --progress ${src_path}/ ${dest_path}
